...
val EnglishTextRevampStrings = TextRevampStrings(
    aiBack = "Back",
    aiUsage = "Usage",
    aiCustomInstructions = "Instructions",
    ...
    aiSelectToneMessage = "Choose an instruction above to get started.",
    ...
    aiAddCustomTone = "Add instruction",
    aiCustomToneTitle = "Instructions",
    aiAddNewInstructionTitle = "Add new instruction",
    aiCustomToneDescription = "Create reusable instructions you can pick from the keyboard.",
    aiCustomToneNewHeading = "New instruction",
    aiCustomToneEditHeading = "Edit instruction",
    ...
    aiCustomToneSave = "Save instruction",
    aiCustomToneSaveChanges = "Save changes",
    aiCustomToneCancel = "Cancel",
    aiCustomToneEdit = "Edit instruction",
    aiCustomToneListHeading = "Your instructions",
    aiCustomToneEmpty = "No instructions yet.",
    aiReorderInstructionsTitle = "Reorder instructions",
    aiReorderInstructionsDescription = "Drag to reorder all instructions. Built-in and custom instructions appear on the keyboard in this order.",
    aiReorderInstructionsSave = "Save order",
    aiReorderInstructionsBuiltInBadge = "Built-in",
    aiReorderInstructionsCustomBadge = "Custom",
    aiCustomToneRemove = "Remove instruction",
    ...
    aiCustomToneColorCyan = "Cyan",
    aiCustomToneColorLime = "Lime",
    aiCustomToneColorPink = "Pink",
    aiCustomToneColorRed = "Red",
    aiCustomToneColorYellow = "Yellow",
    aiCustomToneColorBrown = "Brown",
    aiCustomToneColorGrey = "Grey",
    aiCustomToneColorDeepPurple = "Deep purple",
