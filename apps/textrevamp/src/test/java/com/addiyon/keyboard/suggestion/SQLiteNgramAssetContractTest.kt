...
class SQLiteNgramAssetContractTest {
    @Test
    fun ngramLookupsUseClusteredPrimaryKeysInBothAssets() {
    ...
    private fun withDatabase(name: String, block: (Connection) -> Unit) {
        val database = listOf(
            File("language/amharic/build/generated/dictionaryAssets/$name"),
            File("language/english/build/generated/dictionaryAssets/$name"),
            File("../language/amharic/build/generated/dictionaryAssets/$name"),
            File("../language/english/build/generated/dictionaryAssets/$name")
