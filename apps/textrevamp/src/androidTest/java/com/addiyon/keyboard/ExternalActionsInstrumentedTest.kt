...
import com.addiyon.keyboard.features.appshell.FEEDBACK_EMAIL
import com.addiyon.keyboard.features.appshell.KeyboardExternalActions
import com.addiyon.keyboard.features.appshell.feedbackTelegramDeepLink
import com.addiyon.keyboard.features.appshell.feedbackTelegramWebLink
import com.addiyon.keyboard.features.appshell.openFeedbackTelegram
import com.addiyon.keyboard.features.appshell.sendFeedbackEmail
    ...
    fun privacyPolicyUsesBrowsableViewIntentWithoutResolverPreflight() {
        ...
        assertTrue(
            KeyboardExternalActions.openPrivacyPolicy(
                context,
                extraFlags = Intent.FLAG_ACTIVITY_NEW_TASK
            )
        )
        ...
        assertEquals(KeyboardExternalActions.DEFAULT_PRIVACY_POLICY_URL, intent.dataString)
