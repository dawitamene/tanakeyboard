...
```
Amharic keyboard: type in English letters and get Amharic words instantly
```

Alternates:
- `Type Amharic fast using English letters. Word suggestions built in.`
- `Amharic (Geez) keyboard: type in English, get Amharic. English layout too.`
...
- Number row and punctuation: quick access to numbers and Amharic punctuation.
- Clean, modern design: a simple interface built to stay out of your way.
- Theme options: choose the look that fits you.
...
- Anyone who wants to write Amharic in messages, email, social media, notes, and search.
- People more comfortable typing on an English keyboard who still want correct Amharic output.
- Students, writers, and anyone staying connected in Amharic every day.
...
- Add a valid Privacy Policy URL in the Play Console (required for keyboard / input-method apps).
- Confirm the on-device claim is accurate before publishing.
- Complete the Data safety form so it matches the privacy statement above.
- Avoid keyword stuffing, competitor names, and superlative claims ("best", "#1") in all store fields.
