...
data class KeyboardHeightCopy(
    val title: String,
    val back: String,
    val hint: String,
    val reset: String,
    val done: String,
    val previewLanguageName: String
)
    ...
    Row(
        ...
        row.forEach { key ->
            when (key) {
                ...
                KeyData.Space ->
                    SpaceKey(
                        languageDisplayName = previewLanguageName,
                        height = metrics.keyHeight,
                        vibrateOnKeypress = false,
                        soundOnKeypress = false,
                        onClick = {},
                ...
                KeyData.NumberToggle ->
                    NumberToggleKey(
                        isNumberMode = false,
                        alternateNumbersLabel = if (isAmharic) "፣፩፪" else null,
                        height = metrics.keyHeight,
                        vibrateOnKeypress = false,
                        soundOnKeypress = false,
                        onClick = {}
                ...
                KeyData.LanguageToggle ->
                    LanguageToggleKey(
                        presentation = LanguageKeyPresentation("ሀለ", "AB"),
                        height = metrics.keyHeight,
                        vibrateOnKeypress = false,
                        soundOnKeypress = false,
                        onClick = {}
