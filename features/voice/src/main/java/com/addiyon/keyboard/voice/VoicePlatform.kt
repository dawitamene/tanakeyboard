...
internal interface VoiceRecognizerHandle {
    ...
    fun startListening(languageTag: String, allowedLanguageTags: List<String>)
    fun cancel()
    fun destroy()
}
...
private class AndroidVoiceRecognizerHandle(
    ...
    override fun startListening(languageTag: String, allowedLanguageTags: List<String>) {
        recognizer.startListening(recognizerIntent(languageTag, allowedLanguageTags))
    }
...
private fun recognizerIntent(languageTag: String, allowedLanguageTags: List<String>): Intent =
