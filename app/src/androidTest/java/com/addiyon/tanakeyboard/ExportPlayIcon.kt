...
/**
 * Throwaway helper: renders drawable/ic_tana_icon.xml to a 512x512 PNG for the
 * Google Play store icon. Run with:
 *   ./gradlew connectedDebugAndroidTest --tests "*.ExportPlayIcon"
 * Then pull:
 *   adb pull /sdcard/Android/data/com.addiyon.tanakeyboard/files/play_icon_512.png
 */
...
class ExportPlayIcon {
    ...
    fun export() {
        ...
        val drawable = ContextCompat.getDrawable(ctx, R.drawable.ic_tana_icon)!!
