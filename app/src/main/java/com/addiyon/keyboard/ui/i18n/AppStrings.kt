...
val EnglishStrings = AppStrings(
    ...
    aiWorkspaceConnectedDescription = "Rephrase with your Addiyon account.",
    ...
    aiUsageRequestsRemainingFormat = "%1\$d of %2\$d requests remaining",
    ...
    aiErrorQuotaFormat = "Daily limit reached (%d requests left).",
...
val AmharicStrings = AppStrings(
    ...
    aiEmptyTitle = "ተጨማሪ ጽሑፍ ያክሉ",
    aiEmptyMessage = "በAI ማስተካከያ ለመቀጠል ተጨማሪ ጽሑፍ ያክሉ።",
    aiEmptyAction = "መጻፍ ይቀጥሉ",
    aiSelectToneMessage = "ለመጀመር ከላይ ድምፅ ይምረጡ።",
    ...
    aiAccountTitle = "የAI መለያ",
    aiWorkspaceTitle = "የእርስዎ AI የስራ ቦታ",
    aiWorkspaceConnectedDescription = "በአዲዮን መለያዎ ጭሑፍን ያሻሽሉ።",
    aiWorkspaceDisconnectedDescription = "የAI መዳረሻዎን በመሳሪያዎች ላይ ለማቆየት ይግቡ።",
    aiUsageTitle = "የዛሬ AI አጠቃቀም",
    aiUsageRemaining = "ቀሪ",
    aiUsageRequestsRemainingFormat = "ከ%2\$d ጥያቄዎች %1\$d ቀርተዋል",
    aiUsageResetTodayFormat = "ዛሬ %s ላይ ዳግም ይጀምራል",
    aiUsageResetTomorrowFormat = "ነገ %s ላይ ዳግም ይጀምራል",
    aiUsageResetDateFormat = "%s፣ %s ላይ ዳግም ይጀምራል",
    aiAccountSectionTitle = "መለያ",
    aiAccountFallback = "የአዲዮን መለያ",
    aiAnonymousAccess = "ያልተመዘገበ መዳረሻ",
    aiAccountDisconnectedDescription = "መለያዎን ለማገናኘት ይግቡ",
    aiSignOut = "ውጣ",
    aiSignInAction = "ወደ አዲዮን AI ይግቡ",
    aiInputLabel = "ግቤት",
    ...
    aiErrorQuotaFormat = "የዕለት ገደቡ ደርሷል (%d ጥያቄዎች ቀርተዋል)።",
