...
/**
 * Whether AddiyonKeyboardService is enabled/default, asked of the live system
 ...
 * system mixes short (".AddiyonKeyboardService") and fully-qualified class
 * forms depending on OS version/OEM.
 */
object KeyboardStatus {
    private fun self(context: Context) =
        ComponentName(context, AddiyonKeyboardService::class.java)
