...
class SQLiteDictionary(
    ...
    fun suggestionEntriesForPrefixes(
        ...
        return try {
            ...
            store.reportFailure(t, "SQLiteDictionary.suggestionEntriesForPrefixes")
            emptyMap()
        }
    }
    ...
    fun suggestionEntries(prefix: String, limit: Int = 3): List<Suggestion> {
        ...
        try {
            ...
            store.handleQueryFailure(t)
            store.reportFailure(t, "SQLiteDictionary.suggestionEntries")
            return emptyList()
        }
    ...
    fun frequencyOf(word: String): Int? {
        ...
        return try {
            ...
            store.handleQueryFailure(t)
            store.reportFailure(t, "SQLiteDictionary.frequencyOf")
            null
        }
    }
    ...
    fun frequenciesOf(words: Collection<String>): Map<String, Int> {
        ...
        try {
            ...
            store.handleQueryFailure(t)
            store.reportFailure(t, "SQLiteDictionary.frequenciesOf")
            return emptyMap()
        }
        return buildMap {
    ...
    fun fuzzySuggestions(
        ...
        try {
            ...
            store.handleQueryFailure(t)
            store.reportFailure(t, "SQLiteDictionary.fuzzySuggestions")
            return emptyList()
        }
