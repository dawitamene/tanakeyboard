 ...
 * in KeyboardPrefs, the ReviewManager call in the shared app shell) just consult this.
 *
 ...
 * keyboard for a while are asked — Play guidance is to request the review
