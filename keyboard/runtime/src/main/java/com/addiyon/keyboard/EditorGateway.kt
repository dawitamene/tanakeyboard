...
data class EditorRead<out T>(
    override val value: T,
    val token: EditorToken
) : EditorReadValue<T>

data class EditorSurroundingText(
    val text: String,
    val offset: Int,
    val selectionStart: Int,
    val selectionEnd: Int,
...
data class EditorContentIdentity(
    val selectionStart: Int,
    val selectionEnd: Int,
    val textBeforeSelection: String,
    val textAfterSelection: String
...
data class EditorReplacementSnapshot(
    val token: EditorToken,
 ...
 */
fun surroundingTextFromDirectRead(
    text: String,
    offset: Int,
    selectionStart: Int,
    selectionEnd: Int,
